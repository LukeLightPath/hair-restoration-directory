...
const NEARBY: Record<string, string[]> = {
  ...
  'Portsmouth': ['Southampton', 'Bournemouth', 'Brighton', 'Chichester', 'Winchester'],
  'Brighton': ['Portsmouth', 'London', 'Crawley', 'Eastbourne', 'Worthing'],
  ...
  'Croydon': ['London', 'Brighton', 'Kingston upon Thames', 'Bromley', 'Sutton'],
  ...
  'Maidstone': ['London', 'Canterbury', 'Brighton', 'Tunbridge Wells', 'Ashford'],
  ...
  'Guildford': ['London', 'Basingstoke', 'Brighton', 'Woking', 'Reading'],
